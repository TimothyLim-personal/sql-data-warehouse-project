...
BEGIN
	...
	BEGIN TRY
		...
		-- clean and create table silver.crm_cust_info
		...
		/* clean and create silver.crm_prd_info */
		SET @start_time = GETDATE();
		...
		*/
		...
		/* clean and create silver.crm_sales_details */
		SET @start_time = GETDATE();
		...
		-- clean table bronze.erp_cust_az12
		SET @start_time = GETDATE();
